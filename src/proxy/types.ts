import { _ProxyConstructor, _ProxyHandler } from '../internal/types'
...
export interface ToProxify {
  <T extends object>(target: T, getGetter: () => Getter<T>, isFreeze: () => boolean): InstanceType<_ProxyConstructor>
}
